...
from headingholdtask2_2 import headingholdtask
...
class Main_ui:
    ...
    def model_choose(self):
        ...
        self.task_obj = {
            ...
            "latitude": self.data_recv["latitude"],
            "longitude": self.data_recv["longitude"],
            "mark_latitude": self.task_obj.get("mark_latitude", 0.0),  # 从网页中获取目标经纬度
            "mark_longitude": self.task_obj.get("mark_longitude", 0.0),  # 从网页中获取目标经纬度
        }
